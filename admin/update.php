...
if (isset($_POST['update'])) {
    ...
    $price = mysqli_real_escape_string($connection, $_POST['image_price']);
    $query = $connection->query("UPDATE `port_image` SET `image_name`='$name',`price`='$price' WHERE `id`='$id'");
    if ($query) {
    ...
    ***********************************-->
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="row">
                <?php
                $image_fetch = $connection->query("SELECT `image_name`, `price` FROM `port_image` WHERE `id`='$id'");
                ...
                <div>
                    <div class="form-row align-items-center">
                        <div class="col-auto">
                            <input type="text" name="image_name" class="form-control mb-2" value="<?php echo $image_name;?>"
                                   placeholder="Image Name">
                        </div>
                        <div class="col-auto">
                            <div class="input-group mb-2">
                                <input type="number" name="image_price" class="form-control" value="<?php echo $image_price;?>"
